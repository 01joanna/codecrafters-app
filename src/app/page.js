...
export default function Home() {
  return (
    <div className="bg-white flex flex-col gap-8 mb-12">
      ...
      <aside className="flex flex-col gap-16">
        ...
        <Button text="Browse all events" className="bg-lightmayonnaise py-2 px-36 rounded-xl" />
        </div>
      </aside>
    </div>
  );
