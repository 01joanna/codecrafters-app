        ...
        <p>No hay ningún login</p>
                ...
                <aside className="flex flex-col gap-16">
                        <p className="m-8">
                            ...
                            <Link href="/auth/logout"><button className="text-black px-8 py-1 rounded-full cursor-pointer text-xl hover:bg-opacity-80 transition-colors duration-300 flex">Logout</button></Link>
                        </p>
