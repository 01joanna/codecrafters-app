...
export default function Profile() {
    ...
    return (
        <main className="h-full flex flex-col items-center border-2 ">
            ...
            <section id='prf' className="flex flex-col gap-4 md:w-full lg:w-[50%] h-[465px] border border-lightmayonnaise rounded-xl items-center lg:ml-10 md:ml-0 justify-center py-10">
            ...
            <aside className="lg:w-[40%] md:w-full md:justify-center lg:justify-start h-[465px] border border-lightmayonnaise items-center justify-center flex flex-col rounded-xl gap-6">
                <h2 className='font-light text-md pt-3'>Edit your profile</h2>
                <div className='flex flex-col gap-3 md:items-center lg:items-start'>
                    <form onSubmit={handleUpdate} action="" className="flex flex-col gap-2 justify-center items-center">
